...
namespace RevitMCPCommandSet.Utils
{
    public static class ProjectUtils
    {
            ...
            View view = null)
        {
            ...
            switch (familySymbol.Family.FamilyPlacementType)
            {
                ...
                case FamilyPlacementType.TwoLevelsBased:
                    ...
                    if (ElementIdUtils.GetIdValue(familySymbol.Category.Id) == (int)BuiltInCategory.OST_StructuralColumns)
        ...
        public static Level CreateOrGetLevel(this Document doc, double elevation, string levelName)
        {
            ...
            {
                levelName = $"{levelName}_{ElementIdUtils.GetIdValue(newLevel.Id).ToString()}";
            }
